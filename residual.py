...
class ResBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        res3 = x
        highway = nn.Conv2d(20, 30, 1,  bias=False).cuda()
        res3 = highway(res3).cuda()
        ...
        res4 = x
        highway = nn.Conv2d(30, 40, 1,  bias=False).cuda()
        res4 = highway(res4).cuda()
...
if __name__ == "__main__":
    # Example:
    run(10, 1e-3, 0.1, ClassType.NORMAL_INFECTED, save="infected-covid.model")
