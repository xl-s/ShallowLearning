...
class ResBlock(nn.Module):
    def __init__(self):
        ...
        self.conv1x1 = nn.Conv2d(1, 10, 1, bias=False)

        self.kern3x3 = nn.Sequential(
    ...
    def forward(self, x):
        ...
        for layer in self.kern3x3:
            inp3x3 = layer(inp3x3)

        for layer in self.kern5x5:
            inp5x5 = layer(inp5x5)
        ...
        print(inp3x3.size(), inp5x5.size(), inpmax.size(), x.size())
        out = inp3x3 + inp5x5 + inpmax + x
